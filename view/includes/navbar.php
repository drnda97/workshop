<nav class="clearfix">
	<?php if(!isset($_GET['url'])) : ?>
		<a href="http://localhost/igorjanosevic/workshop/" class="mocking"><img src="./assets/images/logo1.png"></a>
	<?php else : ?>
		<a href="http://localhost/igorjanosevic/workshop/" class="mocking"><img src="<?php dirname('includes/header.php', 1) ?>../assets/images/logo1.png"></a>
	<?php endif; ?>
	<ul>
		<li><a href="http://www.drndarevic.com/">Pocetna</a></li>
